...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function el(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ja(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function nl(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ja(),fragmentShader:`
	...
	`}function cp(i){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Zr||l===Kr,u=l===yi||l===Ti;if(c||u){let d=t.get(o);const f=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new Qo(i)),d=c?e.fromEquirectangular(o,d):e.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),d.texture;if(d!==void 0)return d.texture;{const m=o.image;return c&&m&&m.height>0||u&&m&&s(m)?(e===null&&(e=new Qo(i)),d=c?e.fromEquirectangular(o):e.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,t.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function hp(i){const t={};function e(n){if(t[n]!==void 0)return t[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return t[n]=s,s}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const s=e(n);return s===null&&Ws("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function up(i,t,e,n){const s={},r=new WeakMap;function a(d){const f=d.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);f.removeEventListener("dispose",a),delete s[f.id];const m=r.get(f);m&&(t.remove(m),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(d,f){return s[f.id]===!0||(f.addEventListener("dispose",a),s[f.id]=!0,e.memory.geometries++),f}function l(d){const f=d.attributes;for(const m in f)t.update(f[m],i.ARRAY_BUFFER)}function c(d){const f=[],m=d.index,g=d.attributes.position;let M=0;if(m!==null){const b=m.array;M=m.version;for(let T=0,E=b.length;T<E;T+=3){const L=b[T+0],C=b[T+1],R=b[T+2];f.push(L,C,C,R,R,L)}}else if(g!==void 0){const b=g.array;M=g.version;for(let T=0,E=b.length/3-1;T<E;T+=3){const L=T+0,C=T+1,R=T+2;f.push(L,C,C,R,R,L)}}else return;const p=new(Bl(f)?kl:Vl)(f,1);p.version=M;const h=r.get(d);h&&t.remove(h),r.set(d,p)}function u(d){const f=r.get(d);if(f){const m=d.index;m!==null&&f.version<m.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function dp(i,t,e){let n;function s(f){n=f}let r,a;function o(f){r=f.type,a=f.bytesPerElement}function l(f,m){i.drawElements(n,m,r,f*a),e.update(m,n,1)}function c(f,m,g){g!==0&&(i.drawElementsInstanced(n,m,r,f*a,g),e.update(m,n,g))}function u(f,m,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,f,0,g);let p=0;for(let h=0;h<g;h++)p+=m[h];e.update(p,n,1)}function d(f,m,g,M){if(g===0)return;const p=t.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<f.length;h++)c(f[h]/a,m[h],M[h]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,f,0,M,0,g);let h=0;for(let b=0;b<g;b++)h+=m[b]*M[b];e.update(h,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function fp(i){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(e.calls++,a){case i.TRIANGLES:e.triangles+=o*(r/3);break;case i.LINES:e.lines+=o*(r/2);break;case i.LINE_STRIP:e.lines+=o*(r-1);break;case i.LINE_LOOP:e.lines+=o*r;break;case i.POINTS:e.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:s,update:n}}function pp(i,t,e){const n=new WeakMap,s=new Kt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let f=n.get(o);if(f===void 0||f.count!==d){let x=function(){I.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,M=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let E=0;g===!0&&(E=1),M===!0&&(E=2),p===!0&&(E=3);let L=o.attributes.position.count*E,C=1;L>t.maxTextureSize&&(C=Math.ceil(L/t.maxTextureSize),L=t.maxTextureSize);const R=new Float32Array(L*C*4*d),I=new zl(R,L,C,d);I.type=un,I.needsUpdate=!0;const S=E*4;for(let A=0;A<d;A++){const H=h[A],O=b[A],k=T[A],Z=L*C*4*A;for(let X=0;X<H.count;X++){const $=X*S;g===!0&&(s.fromBufferAttribute(H,X),R[Z+$+0]=s.x,R[Z+$+1]=s.y,R[Z+$+2]=s.z,R[Z+$+3]=0),M===!0&&(s.fromBufferAttribute(O,X),R[Z+$+4]=s.x,R[Z+$+5]=s.y,R[Z+$+6]=s.z,R[Z+$+7]=0),p===!0&&(s.fromBufferAttribute(k,X),R[Z+$+8]=s.x,R[Z+$+9]=s.y,R[Z+$+10]=s.z,R[Z+$+11]=k.itemSize===4?s.w:1)}}f={count:d,texture:I,size:new Ct(L,C)},n.set(o,f),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,e);else{let g=0;for(let p=0;p<c.length;p++)g+=c[p];const M=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",M),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(i,"morphTargetsTextureSize",f.size)}return{update:r}}function mp(i,t,e,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,d=t.get(l,u);if(s.get(d)!==c&&(t.update(d),s.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(e.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;s.get(f)!==c&&(f.update(),s.set(f,c))}return d}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:r,dispose:a}}const Ql=new Ee,il=new jl(1,1),tc=new zl,ec=new Oh,nc=new Yl,sl=[],rl=[],al=new Float32Array(16),ol=new Float32Array(9),ll=new Float32Array(4);function Ni(i,t,e){const n=i[0];if(n<=0||n>0)return i;const s=t*e;let r=sl[s];if(r===void 0&&(r=new Float32Array(s),sl[s]=r),t!==0){n.toArray(r,0);for(let a=1,o=0;a!==t;++a)o+=e,i[a].toArray(r,o)}return r}function ce(i,t){if(i.length!==t.length)return!1;for(let e=0,n=i.length;e<n;e++)if(i[e]!==t[e])return!1;return!0}function he(i,t){for(let e=0,n=t.length;e<n;e++)i[e]=t[e]}function ir(i,t){let e=rl[t];e===void 0&&(e=new Int32Array(t),rl[t]=e);for(let n=0;n!==t;++n)e[n]=i.allocateTextureUnit();return e}function _p(i,t){const e=this.cache;e[0]!==t&&(i.uniform1f(this.addr,t),e[0]=t)}function gp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ce(e,t))return;i.uniform2fv(this.addr,t),he(e,t)}}function vp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(i.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(ce(e,t))return;i.uniform3fv(this.addr,t),he(e,t)}}function xp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ce(e,t))return;i.uniform4fv(this.addr,t),he(e,t)}}function Mp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ce(e,t))return;i.uniformMatrix2fv(this.addr,!1,t),he(e,t)}else{if(ce(e,n))return;ll.set(n),i.uniformMatrix2fv(this.addr,!1,ll),he(e,n)}}function Sp(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ce(e,t))return;i.uniformMatrix3fv(this.addr,!1,t),he(e,t)}else{if(ce(e,n))return;ol.set(n),i.uniformMatrix3fv(this.addr,!1,ol),he(e,n)}}function Ep(i,t){const e=this.cache,n=t.elements;if(n===void 0){if(ce(e,t))return;i.uniformMatrix4fv(this.addr,!1,t),he(e,t)}else{if(ce(e,n))return;al.set(n),i.uniformMatrix4fv(this.addr,!1,al),he(e,n)}}function yp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1i(this.addr,t),e[0]=t)}function Tp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ce(e,t))return;i.uniform2iv(this.addr,t),he(e,t)}}function bp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ce(e,t))return;i.uniform3iv(this.addr,t),he(e,t)}}function Ap(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ce(e,t))return;i.uniform4iv(this.addr,t),he(e,t)}}function wp(i,t){const e=this.cache;e[0]!==t&&(i.uniform1ui(this.addr,t),e[0]=t)}function Rp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(i.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(ce(e,t))return;i.uniform2uiv(this.addr,t),he(e,t)}}function Cp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(i.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(ce(e,t))return;i.uniform3uiv(this.addr,t),he(e,t)}}function Pp(i,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(i.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(ce(e,t))return;i.uniform4uiv(this.addr,t),he(e,t)}}function Dp(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(il.compareFunction=Ol,r=il):r=Ql,e.setTexture2D(t||r,s)}function Lp(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture3D(t||ec,s)}function Up(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTextureCube(t||nc,s)}function Ip(i,t,e){const n=this.cache,s=e.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),e.setTexture2DArray(t||tc,s)}function Np(i){switch(i){case 5126:return _p;case 35664:return gp;case 35665:return vp;case 35666:return xp;case 35674:return Mp;case 35675:return Sp;case 35676:return Ep;case 5124:case 35670:return yp;case 35667:case 35671:return Tp;case 35668:case 35672:return bp;case 35669:case 35673:return Ap;case 5125:return wp;case 36294:return Rp;case 36295:return Cp;case 36296:return Pp;case 35678:case 36198:case 36298:case 36306:case 35682:return Dp;case 35679:case 36299:case 36307:return Lp;case 35680:case 36300:case 36308:case 36293:return Up;case 36289:case 36303:case 36311:case 36292:return Ip}}function Fp(i,t){i.uniform1fv(this.addr,t)}function Op(i,t){const e=Ni(t,this.size,2);i.uniform2fv(this.addr,e)}function Bp(i,t){const e=Ni(t,this.size,3);i.uniform3fv(this.addr,e)}function zp(i,t){const e=Ni(t,this.size,4);i.uniform4fv(this.addr,e)}function Hp(i,t){const e=Ni(t,this.size,4);i.uniformMatrix2fv(this.addr,!1,e)}function Gp(i,t){const e=Ni(t,this.size,9);i.uniformMatrix3fv(this.addr,!1,e)}function Vp(i,t){const e=Ni(t,this.size,16);i.uniformMatrix4fv(this.addr,!1,e)}function kp(i,t){i.uniform1iv(this.addr,t)}function Wp(i,t){i.uniform2iv(this.addr,t)}function Xp(i,t){i.uniform3iv(this.addr,t)}function Yp(i,t){i.uniform4iv(this.addr,t)}function qp(i,t){i.uniform1uiv(this.addr,t)}function jp(i,t){i.uniform2uiv(this.addr,t)}function Zp(i,t){i.uniform3uiv(this.addr,t)}function Kp(i,t){i.uniform4uiv(this.addr,t)}function $p(i,t,e){const n=this.cache,s=t.length,r=ir(e,s);ce(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTexture2D(t[a]||Ql,r[a])}function Jp(i,t,e){const n=this.cache,s=t.length,r=ir(e,s);ce(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTexture3D(t[a]||ec,r[a])}function Qp(i,t,e){const n=this.cache,s=t.length,r=ir(e,s);ce(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTextureCube(t[a]||nc,r[a])}function tm(i,t,e){const n=this.cache,s=t.length,r=ir(e,s);ce(n,r)||(i.uniform1iv(this.addr,r),he(n,r));for(let a=0;a!==s;++a)e.setTexture2DArray(t[a]||tc,r[a])}function em(i){switch(i){case 5126:return Fp;case 35664:return Op;case 35665:return Bp;case 35666:return zp;case 35674:return Hp;case 35675:return Gp;case 35676:return Vp;case 5124:case 35670:return kp;case 35667:case 35671:return Wp;case 35668:case 35672:return Xp;case 35669:case 35673:return Yp;case 5125:return qp;case 36294:return jp;case 36295:return Zp;case 36296:return Kp;case 35678:case 36198:case 36298:case 36306:case 35682:return $p;case 35679:case 36299:case 36307:return Jp;case 35680:case 36300:case 36308:case 36293:return Qp;case 36289:case 36303:case 36311:case 36292:return tm}}class nm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=Np(e.type)}}class im{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=em(e.type)}}class sm{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(t,e[o.id],n)}}}const Br=/(\w+)(\])?(\[|\.)?/g;function cl(i,t){i.seq.push(t),i.map[t.id]=t}function rm(i,t,e){const n=i.name,s=n.length;for(Br.lastIndex=0;;){const r=Br.exec(n),a=Br.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){cl(e,c===void 0?new nm(o,i,t):new im(o,i,t));break}else{let d=e.map[o];d===void 0&&(d=new sm(o),cl(e,d)),e=d}}}class Xs{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=t.getActiveUniform(e,s),a=t.getUniformLocation(e,r.name);rm(r,a,this)}}setValue(t,e,n,s){const r=this.map[e];r!==void 0&&r.setValue(t,n,s)}setOptional(t,e,n){const s=e[n];s!==void 0&&this.setValue(t,n,s)}static upload(t,e,n,s){for(let r=0,a=e.length;r!==a;++r){const o=e[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,s)}}static seqWithValue(t,e){const n=[];for(let s=0,r=t.length;s!==r;++s){const a=t[s];a.id in e&&n.push(a)}return n}}function hl(i,t,e){const n=i.createShader(t);return i.shaderSource(n,e),i.compileShader(n),n}const am=37297;let om=0;function lm(i,t){const e=i.split(`
`),n=[],s=Math.max(t-6,0),r=Math.min(t+6,e.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const ul=new Dt;function cm(i){kt._getMatrix(ul,kt.workingColorSpace,i);const t=`mat3( ${ul.elements.map(e=>e.toFixed(4))} )`;switch(kt.getTransfer(i)){case qs:return[t,"LinearTransferOETF"];case jt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[t,"LinearTransferOETF"]}}function dl(i,t,e){const n=i.getShaderParameter(t,i.COMPILE_STATUS),s=i.getShaderInfoLog(t).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+lm(i.getShaderSource(t),a)}else return s}function hm(i,t){const e=cm(t);return[`vec4 ${i}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function um(i,t){let e;switch(t){case jc:e="Linear";break;case Zc:e="Reinhard";break;case Kc:e="Cineon";break;case $c:e="ACESFilmic";break;case Qc:e="AgX";break;case th:e="Neutral";break;case Jc:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Os=new P;function dm(){kt.getLuminanceCoefficients(Os);const i=Os.x.toFixed(4),t=Os.y.toFixed(4),e=Os.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function mm(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function Wi(i){return i!==""}function fl(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function pl(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const _m=/^[ \t]*#include +<([\w\d./]+)>/gm;function ba(i){return i.replace(_m,vm)}const gm=new Map;function vm(i,t){let e=Ut[t];if(e===void 0){const n=gm.get(t);if(n!==void 0)e=Ut[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return ba(e)}const xm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ml(i){return i.replace(xm,Mm)}function Mm(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function _l(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function Sm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Al?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===Da?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(t="SHADOWMAP_TYPE_VSM"),t}function Em(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case yi:case Ti:t="ENVMAP_TYPE_CUBE";break;case tr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function ym(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ti:t="ENVMAP_MODE_REFRACTION";break}return t}function Tm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case La:t="ENVMAP_BLENDING_MULTIPLY";break;case Yc:t="ENVMAP_BLENDING_MIX";break;case qc:t="ENVMAP_BLENDING_ADD";break}return t}function bm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Am(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Sm(e),c=Em(e),u=ym(e),d=Tm(e),f=bm(e),m=fm(e),g=pm(r),M=s.createProgram();let p,h,b=e.glslVersion?"#version "+e.glslVersion+`
...
`;document.body.appendChild(mn);const yl=document.getElementById("daySlider"),Ze=document.createElement("div");Ze.style.position="absolute";Ze.style.top="10px";Ze.style.left="10px";Ze.style.color="white";Ze.style.fontSize="16px";Ze.style.backgroundColor="rgba(0,0,0,0.5)";Ze.style.padding="5px";Ze.innerHTML="Spins: 0";document.body.appendChild(Ze);const pn=30,qn=0,__=new tn(5,32,32),g_=new as({color:16776960}),Qa=new de(__,g_);Qa.position.set(0,qn,0);je.add(Qa);const Ln=new uu(16777215,1e3,100);Ln.position.set(0,0,0);je.add(Ln);Ln.castShadow=!0;Ln.shadow.mapSize.width=2048;Ln.shadow.mapSize.height=2048;Ln.shadow.camera.near=.1;Ln.shadow.camera.far=200;Ln.shadow.bias=-.005;Dn.shadowMap.needsUpdate=!0;const v_=new $l(16777215,.05);je.add(v_);const x_=new P(0,1,0),M_=new P(0,qn+5,0),S_=new mu(x_,M_,2,16776960,1.5,.75);je.add(S_);const ac=[],Tl=128;for(let i=0;i<=Tl;i++){const t=i/Tl*Math.PI*2;ac.push(new P(pn*Math.cos(t),qn,pn*Math.sin(t)))}const E_=new ve().setFromPoints(ac),y_=new Jn({color:16777215});Ja=new su(E_,y_);je.add(Ja);const T_=[{label:"NF<br>Equinox",angle:0,color:65280},{label:"LN",angle:60,color:255},{label:"TLN<br>Solstice",angle:90,color:16711680},{label:"NS",angle:120,color:255},{label:"DS<br>Z Axis",angle:180,color:65280},{label:"LD",angle:240,color:16776960},{label:"TLD<br>X Axis",angle:270,color:16711680},{label:"DF",angle:300,color:16776960}],Qs=[];T_.forEach(({label:i,angle:t,color:e})=>{const n=ss.degToRad(t),s=pn*Math.cos(n),r=pn*Math.sin(n),a=[new P(0,qn,0),new P(s,qn,r)],o=new ve().setFromPoints(a),l=new Jn({color:e}),c=new Ui(o,l);je.add(c),rc.push(c);const u=document.createElement("div");u.style.position="absolute",u.style.color="white",u.style.fontSize="14px",u.innerHTML=i,document.body.appendChild(u),Qs.push({element:u,position:new P(s,qn,r)})});const b_=new tn(2,32,32),A_=new Zl,to=A_.load("textures/halferth.png");to.center.set(.5,.5);to.rotation=Math.PI/2;const w_=new Ii({map:to,shininess:10}),ls=new de(b_,w_);ls.rotation.x=Math.PI/2;je.add(ls);ls.castShadow=!0;ls.receiveShadow=!0;Qa.receiveShadow=!0;const R_=10,C_=new Jn({color:16711680}),P_=[new P(0,0,0),new P(0,R_/2,0)],D_=new ve().setFromPoints(P_),eo=new Ui(D_,C_);eo.visible=!0;const _n=new Oe;_n.add(eo);const no=new Oe;no.add(ls);_n.add(no);_n.rotation.x=ss.degToRad(12.5);_n.position.set(pn,qn,0);const oc=new Oe;oc.add(_n);je.add(oc);const lc=new Zl,L_=lc.load("textures/mother.png"),U_=lc.load("textures/daughter.png"),I_=70,N_=35,io=.35,so=.3,wi=7,ns=wi*(413e3/656e3),cc=wi*Math.sqrt(1-io**2),hc=ns*Math.sqrt(1-so**2),F_=1,O_=.6;function uc(i,t){const e=new ve;e.setAttribute("position",new Ye(t,3));const n=new Jn({color:i}),s=new Ui(e,n);return je.add(s),s}$s=uc(16711935,Ka);Js=uc(65535,$a);const cs=new Oe;cs.rotation.z=ss.degToRad(12.5);_n.add(cs);const B_=new tn(F_,32,32),z_=new Ii({map:L_}),Ri=new de(B_,z_);Ri.castShadow=!0;Ri.receiveShadow=!0;const dc=new Oe;dc.add(Ri);cs.add(dc);const H_=new tn(O_,32,32),G_=new Ii({map:U_}),Ci=new de(H_,G_);Ci.castShadow=!0;Ci.receiveShadow=!0;const fc=new Oe;fc.add(Ci);cs.add(fc);_n.traverse(i=>{i.isMesh&&(i.castShadow=!0,i.receiveShadow=!0)});cs.traverse(i=>{i.isMesh&&(i.castShadow=!0,i.receiveShadow=!0)});function pc(i){if(requestAnimationFrame(pc),Fi.update(),Ys){Qs.forEach(({element:S,position:x})=>{const A=x.clone().project(Fe);S.style.left=`${(A.x*.5+.5)*window.innerWidth}px`,S.style.top=`${(-A.y*.5+.5)*window.innerHeight}px`}),Dn.render(je,Fe);return}if(Aa.fullSpins=Wn,Aa.totalSpin=Tn,!Xi){Xi=i;return}const t=(i-Xi)/1e3;Xi=i;const e=2*Math.PI/62.8;Si+=e*t;const n=pn*Math.cos(Si),s=pn*Math.sin(Si);_n.position.set(n,0,s);const a=e*420*t;if(no.rotation.y-=a,Tn+=a,Tn>=Math.PI*2){const S=Math.floor(Tn/(Math.PI*2));Wn+=S,Tn%=Math.PI*2}const o=Wn%420+1,l=Math.floor((o-1)/70),c=(o-1)%35+1,u=(o-1)%70<35,f=["Nightfall","Long Night","Nightspring","Dayspring","Long Day","Dayfall"][l]||"Unknown",m=`${u?"Low":"High"} ${f}`;Ze.innerHTML=`
  Day of Halferth Year: ${o}<br>
  Season: ${f}<br>
  Date: Day ${c} of ${m}
`;const g=Wn+Tn/(2*Math.PI),M=-Math.PI,p=g/I_*2*Math.PI+M,h=g/N_*2*Math.PI+M,b=wi*io,T=ns*so,E=cc*Math.cos(p),L=wi*Math.sin(p)+b;Ri.position.set(E,L,0);const C=hc*Math.cos(h),R=ns*Math.sin(h)+T;Ci.position.set(C,R,0),++m_%2===0&&Qs.forEach(({element:S,position:x})=>{const A=x.clone().project(Fe);S.style.left=`${(A.x*.5+.5)*window.innerWidth}px`,S.style.top=`${(-A.y*.5+.5)*window.innerHeight}px`}),window._fpsLastTime||(window._fpsLastTime=i),window._fpsFrames||(window._fpsFrames=0),window._fpsFrames++,i-window._fpsLastTime>1e3&&(console.log("FPS:",window._fpsFrames),window._fpsFrames=0,window._fpsLastTime=i);function I(S,x,A,H){const O=new P;if(S.getWorldPosition(O),A>=ji){for(let k=0;k<(ji-1)*3;k++)x[k]=x[k+3];x.set([O.x,O.y,O.z],(ji-1)*3)}else x.set([O.x,O.y,O.z],A*3),A++,H.geometry.setDrawRange(0,A);return H.geometry.attributes.position.needsUpdate=!0,A}wa&&(Ra=I(Ri,Ka,Ra,$s),Ca=I(Ci,$a,Ca,Js)),window.fullSpins=Wn,window.totalSpin=Tn,Dn.render(je,Fe)}const bl=30;window.addEventListener("resize",()=>{Fe.left=window.innerWidth/-30,Fe.right=window.innerWidth/bl,Fe.top=window.innerHeight/bl,Fe.bottom=window.innerHeight/-30,Fe.updateProjectionMatrix(),Dn.setSize(window.innerWidth,window.innerHeight)});pc();document.getElementById("toggleTrails").addEventListener("change",i=>{wa=i.target.checked,wa||(Ka.fill(0),$a.fill(0),Ra=0,Ca=0,$s.geometry.setDrawRange(0,0),Js.geometry.setDrawRange(0,0),$s.geometry.attributes.position.needsUpdate=!0,Js.geometry.attributes.position.needsUpdate=!0)});document.getElementById("toggleLines").addEventListener("change",i=>{const t=i.target.checked;Ja.visible=t,eo.visible=t,rc.forEach(e=>e.visible=t)});document.getElementById("toggleLabels").addEventListener("change",i=>{const t=i.target.checked;Qs.forEach(({element:e})=>{e.style.display=t?"block":"none"})});yl.addEventListener("input",()=>{const i=parseInt(yl.value,10);Wn=i-1,Tn=0;const t=Math.floor((i-1)/70),e=(i-1)%35+1,n=(i-1)%70<35,r=["Nightfall","Long Night","Nightspring","Dayspring","Long Day","Dayfall"][t]||"Unknown",a=`${n?"Low":"High"} ${r}`;Ze.innerHTML=`
  Day of Halferth Year: ${i}<br>
  Season: ${r}<br>
  Date: Day ${e} of ${a}
`,Si=i/420*(2*Math.PI);const o=pn*Math.cos(Si),l=pn*Math.sin(Si);_n.position.set(o,0,l);const c=Wn,u=-Math.PI,d=c/70*2*Math.PI+u,f=c/35*2*Math.PI+u,m=wi*io,g=ns*so,M=cc*Math.cos(d),p=wi*Math.sin(d)+m;Ri.position.set(M,p,0);const h=hc*Math.cos(f),b=ns*Math.sin(f)+g;Ci.position.set(h,b,0)});const V_=document.getElementById("simCanvas"),k_=document.getElementById("skyVisContainer"),hs=new ic({canvas:V_});hs.setClearColor(0,1);hs.setSize(600,600);hs.shadowMap.enabled=!0;hs.shadowMap.type=Da;let Zi=!1;const Qn=document.createElement("button");Qn.textContent="Flip View";Qn.style.position="absolute";Qn.style.bottom="10px";Qn.style.left="10px";Qn.style.zIndex="10";k_.appendChild(Qn);Qn.addEventListener("click",()=>{Zi=!Zi,console.log("Flip toggled:",Zi)});const gn=new ql,us=1,Pi=new Pe(60,1,.1,100),mc=us+.1;Pi.position.set(0,mc,0);Pi.up.set(0,1,0);Pi.lookAt(new P(0,mc,Zi?10:-10));gn.add(Pi);const _c=new de(new tn(us,64,64),new Ii({color:5598063}));_c.position.set(0,0,0);gn.add(_c);const gc=new de(new tn(.25,32,32),new Ii({color:16711935}));gc.position.set(0,us-.6,-2.5);gn.add(gc);const vc=new de(new tn(.15,32,32),new Ii({color:65535}));vc.position.set(0,us-.4,-1.5);gn.add(vc);const W_=new Jn({color:16711680}),X_=new ve().setFromPoints([new P(0,0,0),new P(0,1.8,0)]),Y_=new Ui(X_,W_);gn.add(Y_);const ro=new de(new tn(.5,64,64),new as({color:16776960}));ro.position.set(0,0,-10);const ao=new Oe;ao.add(ro);const oo=new Oe;oo.rotation.z=ss.degToRad(-12.5);oo.add(ao);gn.add(oo);const sr=new fu(16777215,1.5);sr.position.set(0,0,-30);sr.castShadow=!0;gn.add(sr);gn.add(new $l(16777215,.05));function xc(){requestAnimationFrame(xc);const i=Aa,e=(i.fullSpins+i.totalSpin/(2*Math.PI))/420*2*Math.PI;ao.rotation.y=-e;const n=new P;ro.getWorldPosition(n),sr.position.copy(n);const s=us+.1;Pi.lookAt(new P(0,s,Zi?10:-10)),hs.render(gn,Pi)}xc();
